...
/* Function for MATLAB Function: '<Root>/xHatt  ' */
static void heli_q8_invNxN(const real_T x[25], real_T y[25])
{
  int8_T p[5];
  real_T A[25];
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* MATLAB Function: '<Root>/AccelToAngles ' */
    /* MATLAB Function 'AccelToAngles ': '<S1>:1' */
    /* '<S1>:1:3' */
    e = 0.0;

    /* '<S1>:1:4' */
    p = 0.0;
    if (!((sqrt(rtb_Gain2[1] * rtb_Gain2[1] + rtb_Gain2[2] * rtb_Gain2[2]) ==
           0.0) || (rtb_Gain2[2] == 0.0))) {
      /* '<S1>:1:13' */
      e = atan(rtb_Gain2[0] / sqrt(rtb_Gain2[1] * rtb_Gain2[1] + rtb_Gain2[2] *
                rtb_Gain2[2]));

      /* '<S1>:1:14' */
      p = atan(rtb_Gain2[1] / rtb_Gain2[2]);
    } else {
      /* '<S1>:1:5' */
    }
    ...
    /* End of MATLAB Function: '<Root>/AccelToAngles ' */
    ...
    /* '<S3>:1:11' */
    tmp_1[0] = 1.0;
    tmp_1[3] = sin(heli_q8_B.TravelCounttorad) * tan(heli_q8_B.PitchCounttorad);
    tmp_1[6] = cos(heli_q8_B.TravelCounttorad) * tan(heli_q8_B.PitchCounttorad);
    tmp_1[1] = 0.0;
    tmp_1[4] = cos(heli_q8_B.TravelCounttorad);
    tmp_1[7] = -sin(heli_q8_B.TravelCounttorad);
    tmp_1[2] = 0.0;
    tmp_1[5] = sin(heli_q8_B.TravelCounttorad) / cos(heli_q8_B.PitchCounttorad);
    tmp_1[8] = cos(heli_q8_B.TravelCounttorad) / cos(heli_q8_B.PitchCounttorad);
    ...
    for (i = 0; i < 3; i++) {
      ...
      heli_q8_B.euler_rates[i] += tmp_1[i] * rtb_Gain2[0];
      heli_q8_B.euler_rates[i] += tmp_1[i + 3] * rtb_Gain2[1];
      heli_q8_B.euler_rates[i] += tmp_1[i + 6] * rtb_Gain2[2];
    }

    /* ManualSwitch: '<Root>/Manual Switch' */
    if (heli_q8_P.ManualSwitch_CurrentSetting == 1) {
      heli_q8_B.ManualSwitch = false;
    } else {
    ...
    /* MATLAB Function: '<Root>/xHatt  ' incorporates:
     *  UnitDelay: '<Root>/Unit Delay'
     *  UnitDelay: '<Root>/Unit Delay1'
     */
    /* MATLAB Function 'xHatt  ': '<S9>:1' */
    if (heli_q8_B.ManualSwitch) {
      /* '<S9>:1:2' */
      /* '<S9>:1:3' */
      for (i = 0; i < 5; i++) {
        for (i_0 = 0; i_0 < 6; i_0++) {
          K_k_0[i + 5 * i_0] = 0.0;
          for (k = 0; k < 6; k++) {
            K_k_0[i + 5 * i_0] += heli_q8_P.C_d[5 * k + i] *
      ...
      for (i = 0; i < 5; i++) {
        for (i_0 = 0; i_0 < 5; i_0++) {
          e = 0.0;
          for (k = 0; k < 6; k++) {
            e += K_k_0[5 * k + i] * heli_q8_P.C_d[5 * k + i_0];
          }

          tmp[i + 5 * i_0] = heli_q8_P.R_d[5 * i_0 + i] + e;
        }
      }
      ...
      for (i = 0; i < 6; i++) {
        for (i_0 = 0; i_0 < 5; i_0++) {
          K_k_0[i + 6 * i_0] = 0.0;
          for (k = 0; k < 6; k++) {
            K_k_0[i + 6 * i_0] += heli_q8_DW.UnitDelay1_DSTATE[6 * k + i] *
      ...
      for (i = 0; i < 6; i++) {
        for (i_0 = 0; i_0 < 5; i_0++) {
          K_k[i + 6 * i_0] = 0.0;
          for (k = 0; k < 5; k++) {
            K_k[i + 6 * i_0] += K_k_0[6 * k + i] * tmp_0[5 * i_0 + k];
          }
        }
      }
      ...
      for (k = 0; k < 6; k++) {
        ...
        for (i = 0; i < 6; i++) {
          e = 0.0;
          for (i_0 = 0; i_0 < 5; i_0++) {
            e += K_k[6 * i_0 + k] * heli_q8_P.C_d[5 * i + i_0];
          }

          I_0[k + 6 * i] = (real_T)I[6 * i + k] - e;
        }
      }
      ...
      for (i = 0; i < 6; i++) {
        for (i_0 = 0; i_0 < 6; i_0++) {
          ...
          e = 0.0;
          for (k = 0; k < 5; k++) {
            e += K_k[6 * k + i_0] * heli_q8_P.C_d[5 * i + k];
          }

          b_I_0[i + 6 * i_0] = (real_T)b_I[6 * i + i_0] - e;
        }

        for (i_0 = 0; i_0 < 5; i_0++) {
          K_k_0[i + 6 * i_0] = 0.0;
          for (k = 0; k < 5; k++) {
            K_k_0[i + 6 * i_0] += K_k[6 * k + i] * heli_q8_P.R_d[5 * i_0 + k];
          }
        }
      }
      ...
      for (i = 0; i < 6; i++) {
        for (i_0 = 0; i_0 < 6; i_0++) {
          ...
          K_k_1[i + 6 * i_0] = 0.0;
          for (k = 0; k < 5; k++) {
            K_k_1[i + 6 * i_0] += K_k_0[6 * k + i] * K_k[6 * k + i_0];
          }
        }
      }
      ...
      for (i = 0; i < 6; i++) {
        for (i_0 = 0; i_0 < 6; i_0++) {
          heli_q8_B.P_h[i_0 + 6 * i] = I_0[6 * i + i_0] + K_k_1[6 * i + i_0];
        }
      }
      ...
      for (i = 0; i < 6; i++) {
        e = 0.0;
        for (i_0 = 0; i_0 < 5; i_0++) {
          e += K_k[6 * i_0 + i] * tmp_4[i_0];
        }

        heli_q8_B.x_h1[i] = heli_q8_DW.UnitDelay_DSTATE[i] + e;
      }
    } else {
      /* '<S9>:1:7' */
      for (i = 0; i < 6; i++) {
        heli_q8_B.x_h1[i] = heli_q8_DW.UnitDelay_DSTATE[i];
      }

      /* '<S9>:1:8' */
      memcpy(&heli_q8_B.P_h[0], &heli_q8_DW.UnitDelay1_DSTATE[0], 36U * sizeof
             (real_T));
    }

    /* End of MATLAB Function: '<Root>/xHatt  ' */

    /* Sum: '<Root>/Sum1' incorporates:
     *  Constant: '<Root>/Constant1'
     */
    heli_q8_B.Sum1 = heli_q8_B.x_h1[2] - heli_q8_P.Constant1_Value_m;

    /* Sum: '<S4>/Subtract' incorporates:
     *  Constant: '<S4>/Constant'
     *  Gain: '<S4>/Elevation: Count to rad'
     */
    heli_q8_B.Subtract = heli_q8_P.ElevationCounttorad_Gain * rtb_DeadZoney -
      heli_q8_P.Constant_Value_p;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    heli_q8_B.TmpSignalConversionAtToWorkspac[0] = heli_q8_B.p;
    heli_q8_B.TmpSignalConversionAtToWorkspac[1] = heli_q8_B.euler_rates[0];
    heli_q8_B.TmpSignalConversionAtToWorkspac[2] = heli_q8_B.e;
    heli_q8_B.TmpSignalConversionAtToWorkspac[3] = heli_q8_B.euler_rates[1];
    heli_q8_B.TmpSignalConversionAtToWorkspac[4] = heli_q8_B.euler_rates[2];
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    heli_q8_B.Constant = heli_q8_P.Constant_Value_j;
    ...
    heli_q8_B.Gain[0] += heli_q8_P.F[0] * heli_q8_B.Joystick_gain_x;
    heli_q8_B.Gain[0] += heli_q8_P.F[2] * heli_q8_B.Joystick_gain_y;
    heli_q8_B.Gain[1] = 0.0;
    heli_q8_B.Gain[1] += heli_q8_P.F[1] * heli_q8_B.Joystick_gain_x;
    heli_q8_B.Gain[1] += heli_q8_P.F[3] * heli_q8_B.Joystick_gain_y;
  }

  /* SignalConversion: '<S8>/TmpSignal ConversionAtkInport1' incorporates:
   *  Gain: '<S8>/k'
   *  Integrator: '<S8>/Integrator'
   *  Integrator: '<S8>/Integrator1'
   */
  tmp_5[0] = heli_q8_B.x_h1[0];
  tmp_5[1] = heli_q8_B.x_h1[1];
  tmp_5[2] = heli_q8_B.x_h1[3];
  tmp_5[3] = heli_q8_X.Integrator_CSTATE;
  tmp_5[4] = heli_q8_X.Integrator1_CSTATE;
  ...
  for (i = 0; i < 2; i++) {
    e = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      e += heli_q8_P.K[(i_0 << 1) + i] * tmp_5[i_0];
    }

    rtb_TmpSignalConversionAtSFun_f[i] = heli_q8_B.Gain[i] - e;
  }

  /* End of Sum: '<S8>/Sum' */

  /* Sum: '<Root>/Sum' */
  heli_q8_B.Sum = heli_q8_B.Constant + rtb_TmpSignalConversionAtSFun_f[0];
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }
   ...
   *  Sum: '<S2>/Add'
   */
  e = (heli_q8_B.Sum - rtb_TmpSignalConversionAtSFun_f[1]) *
    heli_q8_P.Frontgain_Gain;

  /* Saturate: '<S4>/Front motor: Saturation' */
  if (e > heli_q8_P.FrontmotorSaturation_UpperSat) {
    heli_q8_B.FrontmotorSaturation = heli_q8_P.FrontmotorSaturation_UpperSat;
  } else if (e < heli_q8_P.FrontmotorSaturation_LowerSat) {
    heli_q8_B.FrontmotorSaturation = heli_q8_P.FrontmotorSaturation_LowerSat;
  } else {
    heli_q8_B.FrontmotorSaturation = e;
  }
  ...
  /* MATLAB Function: '<Root>/Prediction  ' */
  /* MATLAB Function 'Prediction  ': '<S7>:1' */
  /* '<S7>:1:2' */
  /* '<S7>:1:3' */
  for (i = 0; i < 6; i++) {
    tmp_6[i] = 0.0;
    tmp_7[i] = 0.0;
    tmp_7[i] += heli_q8_P.B_d[i] * rtb_TmpSignalConversionAtSFun_f[0];
    tmp_7[i] += heli_q8_P.B_d[i + 6] * rtb_TmpSignalConversionAtSFun_f[1];
    for (i_0 = 0; i_0 < 6; i_0++) {
      tmp_6[i] += heli_q8_P.A_d[6 * i_0 + i] * heli_q8_B.x_h1[i_0];
      I_0[i + 6 * i_0] = 0.0;
      for (k = 0; k < 6; k++) {
        I_0[i + 6 * i_0] += heli_q8_P.A_d[6 * k + i] * heli_q8_B.P_h[6 * i_0 + k];
      }
    }

    heli_q8_B.x_1[i] = tmp_6[i] + tmp_7[i];
  }
  ...
  for (i = 0; i < 6; i++) {
    for (i_0 = 0; i_0 < 6; i_0++) {
      e = 0.0;
      for (k = 0; k < 6; k++) {
        e += I_0[6 * k + i] * heli_q8_P.A_d[6 * k + i_0];
      }

      heli_q8_B.P_[i + 6 * i_0] = heli_q8_P.Q_d[6 * i_0 + i] + e;
    }
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Sum: '<S8>/Sum1' */
    heli_q8_B.Sum1_e = heli_q8_B.x_h1[0] - heli_q8_B.Joystick_gain_x;

    /* Sum: '<S8>/Sum2' */
    heli_q8_B.Sum2 = heli_q8_B.x_h1[3] - heli_q8_B.Joystick_gain_y;
  }
}
...
void heli_q8_update0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    for (i = 0; i < 6; i++) {
      heli_q8_DW.UnitDelay_DSTATE[i] = heli_q8_B.x_1[i];
    }
    ...
    memcpy(&heli_q8_DW.UnitDelay1_DSTATE[0], &heli_q8_B.P_[0], 36U * sizeof
           (real_T));
  }
...
void heli_q8_derivatives(void)
{
  ...
  _rtXdot->ElevationTransferFcn_CSTATE += heli_q8_P.ElevationTransferFcn_A *
    heli_q8_X.ElevationTransferFcn_CSTATE;
  _rtXdot->ElevationTransferFcn_CSTATE += heli_q8_B.Subtract;
  ...
  _rtXdot->Integrator_CSTATE = heli_q8_B.Sum1_e;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3031847001U);
  heli_q8_M->Sizes.checksums[1] = (2740795001U);
  heli_q8_M->Sizes.checksums[2] = (254198384U);
  heli_q8_M->Sizes.checksums[3] = (611597922U);
  ...
  heli_q8_M->Sizes.numBlocks = (87);   /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (31);  /* Number of block outputs */
