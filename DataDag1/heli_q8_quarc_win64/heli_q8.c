 ...
 * C source code generated on : Wed Sep 09 12:37:46 2020
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Subtract = heli_q8_P.ElevationCounttorad_Gain * rtb_Sum_k -
    ...
    if (heli_q8_B.RateTransitiony > heli_q8_P.DeadZoney_End) {
      rtb_Sum_k = heli_q8_B.RateTransitiony - heli_q8_P.DeadZoney_End;
    } else if (heli_q8_B.RateTransitiony >= heli_q8_P.DeadZoney_Start) {
      rtb_Sum_k = 0.0;
    } else {
      rtb_Sum_k = heli_q8_B.RateTransitiony - heli_q8_P.DeadZoney_Start;
    }
     ...
     *  Gain: '<S4>/Gain: y'
     */
    heli_q8_B.Joystick_gain_y = heli_q8_P.Gainy_Gain * rtb_Sum_k *
      heli_q8_P.Joystick_gain_y;

    /* Sum: '<S2>/Sum' */
    rtb_Sum_k = heli_q8_B.Joystick_gain_y - heli_q8_B.Subtract;
   ...
   *  Sum: '<S6>/Sum'
   */
  heli_q8_B.Add = ((heli_q8_X.Integrator_CSTATE + heli_q8_B.K_ep) -
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Sum: '<S5>/Subtract'
     */
    heli_q8_B.Gain = (heli_q8_B.Joystick_gain_x - heli_q8_B.PitchCounttorad) *
      heli_q8_P.K_pp;
  }
   ...
   *  Gain: '<S5>/Gain1'
   */
  heli_q8_B.Subtract1 = heli_q8_B.Gain - heli_q8_P.K_pd *
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (heli_q8_B.Add - heli_q8_B.Subtract1) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (heli_q8_B.Add + heli_q8_B.Subtract1) * heli_q8_P.Backgain_Gain;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3004332567U);
  heli_q8_M->Sizes.checksums[1] = (2854841430U);
  heli_q8_M->Sizes.checksums[2] = (3752318994U);
  heli_q8_M->Sizes.checksums[3] = (3799836079U);
  ...
  heli_q8_M->Sizes.numBlockPrms = (145);/* Sum of parameter "widths" */
  return heli_q8_M;
}
