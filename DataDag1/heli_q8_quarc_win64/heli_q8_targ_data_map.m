  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% heli_q8_DW.CurrentElevationRad_PWORK.LoggedData
	  section.data(11).logicalSrcIdx = 24;
	  section.data(11).dtTransOffset = 10;
	
	  ;% heli_q8_DW.V_d_PWORK.LoggedData
  ...
  targMap.checksum0 = 3004332567;
  targMap.checksum1 = 2854841430;
  targMap.checksum2 = 3752318994;
  targMap.checksum3 = 3799836079;
