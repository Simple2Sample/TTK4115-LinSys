...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  for (i = 0; i < 5; i++) {
     ...
     */
    heli_q8_B.Sum1_h[i] = (heli_q8_P.B[i + 5] * rtb_Sum[0] + heli_q8_P.B[i] *
      rtb_Sum[1]) + (tmp_3[i] + tmp_1[i]);
  }
}
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3863282309U);
  heli_q8_M->Sizes.checksums[1] = (371864521U);
  heli_q8_M->Sizes.checksums[2] = (380419755U);
  heli_q8_M->Sizes.checksums[3] = (2950277110U);
