 ...
 * C source code generated on : Sun Nov 15 20:32:04 2020
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* '<S1>:1:4' */
    p = 0.0;
    if (!((sqrt(heli_q8_B.Gain2[1] * heli_q8_B.Gain2[1] + heli_q8_B.Gain2[2] *
                heli_q8_B.Gain2[2]) == 0.0) || (heli_q8_B.Gain2[2] == 0.0))) {
      /* '<S1>:1:13' */
      e = atan(heli_q8_B.Gain2[0] / sqrt(heli_q8_B.Gain2[1] * heli_q8_B.Gain2[1]
                + heli_q8_B.Gain2[2] * heli_q8_B.Gain2[2]));

      /* '<S1>:1:14' */
      p = atan(heli_q8_B.Gain2[1] / heli_q8_B.Gain2[2]);
    } else {
      /* '<S1>:1:5' */
    }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* '<S3>:1:11' */
    tmp[0] = 1.0;
    tmp[3] = sin(heli_q8_B.PitchCounttorad) * tan(heli_q8_B.Subtract);
    tmp[6] = cos(heli_q8_B.PitchCounttorad) * tan(heli_q8_B.Subtract);
    tmp[1] = 0.0;
    tmp[4] = cos(heli_q8_B.PitchCounttorad);
    tmp[7] = -sin(heli_q8_B.PitchCounttorad);
    tmp[2] = 0.0;
    tmp[5] = sin(heli_q8_B.PitchCounttorad) / cos(heli_q8_B.Subtract);
    tmp[8] = cos(heli_q8_B.PitchCounttorad) / cos(heli_q8_B.Subtract);
    for (i = 0; i < 3; i++) {
  ...
  tmp_0[3] = heli_q8_X.Integrator_CSTATE_a;
  ...
  for (i = 0; i < 2; i++) {
    e = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      e += heli_q8_P.K[(i_0 << 1) + i] * tmp_0[i_0];
    }

    rtb_Sum[i] = heli_q8_B.Gain[i] - e;
  }

  /* End of Sum: '<S7>/Sum' */

  /* Sum: '<Root>/Sum' */
  heli_q8_B.Sum = heli_q8_B.Constant + rtb_Sum[0];
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }
   ...
   *  Sum: '<S2>/Add'
   */
  e = (heli_q8_B.Sum - rtb_Sum[1]) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S2>/Subtract'
   */
  e = (heli_q8_B.Sum + rtb_Sum[1]) * heli_q8_P.Backgain_Gain;
  ...
  /* Sum: '<S7>/Sum1' */
  heli_q8_B.Sum1 = heli_q8_B.Integrator[0] - heli_q8_B.Joystick_gain_x;

  /* Sum: '<S7>/Sum2' */
  heli_q8_B.Sum2 = heli_q8_B.Integrator[3] - heli_q8_B.Joystick_gain_y;
  ...
  for (i = 0; i < 5; i++) {
    ...
    tmp_0[i] = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp_0[i] += heli_q8_P.C[5 * i_0 + i] * heli_q8_B.Integrator[i_0];
    }
    ...
    tmp_3[i] = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp_3[i] += heli_q8_P.AA[5 * i_0 + i] * heli_q8_B.Integrator[i_0];
    }
  ...
  for (i = 0; i < 5; i++) {
    ...
    tmp_1[i] = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp_1[i] += heli_q8_P.L[5 * i_0 + i] * tmp_2[i_0];
    }

    /* Sum: '<Root>/Sum1' incorporates:
     *  Gain: '<Root>/Gain1'
     */
    heli_q8_B.Sum1_h[i] = (heli_q8_P.B[i + 5] * rtb_Sum[1] + heli_q8_P.B[i] *
      rtb_Sum[0]) + (tmp_3[i] + tmp_1[i]);
  }
}
...
void heli_q8_derivatives(void)
{
  ...
  for (i = 0; i < 5; i++) {
    _rtXdot->Integrator_CSTATE[i] = heli_q8_B.Sum1_h[i];
  }

  /* End of Derivatives for Integrator: '<Root>/Integrator' */

  /* Derivatives for Integrator: '<S7>/Integrator' */
  _rtXdot->Integrator_CSTATE_a = heli_q8_B.Sum1;
...
void heli_q8_initialize(void)
{
...

  {
    ...
    heli_q8_X.Integrator_CSTATE_a = heli_q8_P.Integrator_IC_j;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (1095025798U);
  heli_q8_M->Sizes.checksums[1] = (165653334U);
  heli_q8_M->Sizes.checksums[2] = (4187332413U);
  heli_q8_M->Sizes.checksums[3] = (2568571681U);
  ...
  heli_q8_M->Sizes.numBlockIO = (28);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (530);/* Sum of parameter "widths" */
  return heli_q8_M;
}
