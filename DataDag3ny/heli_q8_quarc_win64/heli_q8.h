...
typedef struct {
  ...
  real_T Integrator[5];                /* '<Root>/Integrator' */
  ...
  real_T Sum1;                         /* '<S7>/Sum1' */
  real_T Sum2;                         /* '<S7>/Sum2' */
  real_T Sum1_h[5];                    /* '<Root>/Sum1' */
  real_T euler_rates[3];               /* '<Root>/Gyro vector to [pitch rate, elevation rate, travle rate]' */
  real_T e;                            /* '<Root>/AccelToAngles ' */
  real_T p;                            /* '<Root>/AccelToAngles ' */
...
typedef struct {
  ...
  struct {
    void *LoggedData[2];
  } Pitchrate_PWORK;                   /* '<Root>/Pitchrate ' */
  ...
  struct {
    void *LoggedData[2];
  } eTransformationComp_PWORK;         /* '<Root>/e TransformationComp' */
  ...
  struct {
    void *LoggedData[2];
  } elevationrate_PWORK;               /* '<Root>/elevationrate' */

  struct {
    void *LoggedData[2];
  } elevationrate_PWORK_c;             /* '<Root>/elevationrate ' */

  struct {
    void *LoggedData[2];
  } pTransformationComp_PWORK;         /* '<Root>/p TransformationComp' */
  ...
  struct {
    void *LoggedData[2];
  } travelrate_PWORK;                  /* '<Root>/travelrate' */

  struct {
    void *LoggedData[2];
  } travelrate_PWORK_g;                /* '<Root>/travelrate  ' */
...
typedef struct {
  real_T Integrator_CSTATE[5];         /* '<Root>/Integrator' */
...
/* State disabled  */
typedef struct {
  boolean_T Integrator_CSTATE[5];      /* '<Root>/Integrator' */
...
struct P_heli_q8_T_ {
  real_T AA[25];                       /* Variable: AA
                                        * Referenced by: '<Root>/Gain'
                                        */
  real_T B[10];                        /* Variable: B
  ...
  real_T ElevationCounttorad_Gain;     /* Expression: -2 * pi /4096
                                        ...
                                        */
  real_T Constant_Value_p;             /* Expression: 0.55
