 ...
 * C source code generated on : Wed Sep 30 16:15:04 2020
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
   ...
   *  S-Function (hil_initialize_block): '<Root>/HIL Initialize'
  ...
  if (heli_q8_M->Timing.t[0] < heli_q8_P.Step_Time) {
    rtb_Step = heli_q8_P.Step_Y0;
  } else {
    rtb_Step = heli_q8_P.Step_YFinal;
  }
  ...
  heli_q8_B.Gain[0] += heli_q8_P.F[0] * rtb_Step;
  heli_q8_B.Gain[0] += heli_q8_P.F[2] * heli_q8_B.Joystick_gain_y;
  heli_q8_B.Gain[1] = 0.0;
  heli_q8_B.Gain[1] += heli_q8_P.F[1] * rtb_Step;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Subtract = heli_q8_P.ElevationCounttorad_Gain *
      rtb_HILReadEncoderTimebase_o3 - heli_q8_P.Constant_Value_p;
  }
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (heli_q8_B.Sum - rtb_Sum[1]) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (heli_q8_B.Sum + rtb_Sum[1]) * heli_q8_P.Backgain_Gain;
  ...
  /* Sum: '<S4>/Sum1' */
  heli_q8_B.Sum1 = heli_q8_B.PitchCounttorad - rtb_Step;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (1424573773U);
  heli_q8_M->Sizes.checksums[1] = (2083594221U);
  heli_q8_M->Sizes.checksums[2] = (2786689531U);
  heli_q8_M->Sizes.checksums[3] = (261209220U);
  ...
  heli_q8_M->Sizes.numBlockPrms = (156);/* Sum of parameter "widths" */
  return heli_q8_M;
}
