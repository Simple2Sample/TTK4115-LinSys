 ...
 * C source code generated on : Wed Nov 11 16:52:18 2020
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
   ...
   */
  tmp_5[0] = heli_q8_B.PitchCounttorad;
  tmp_5[1] = heli_q8_B.PitchTransferFcn;
  tmp_5[2] = heli_q8_B.ElevationTransferFcn;
  ...
  for (i = 0; i < 6; i++) {
    tmp_6[i] = 0.0;
    tmp_7[i] = 0.0;
    tmp_7[i] += heli_q8_P.B_d[i] * rtb_TmpSignalConversionAtSFun_f[1];
    tmp_7[i] += heli_q8_P.B_d[i + 6] * rtb_TmpSignalConversionAtSFun_f[0];
    for (i_0 = 0; i_0 < 6; i_0++) {
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Sum: '<S8>/Sum1' */
    heli_q8_B.Sum1 = heli_q8_B.PitchCounttorad - heli_q8_B.Joystick_gain_x;
  }

  /* Sum: '<S8>/Sum2' */
  heli_q8_B.Sum2 = heli_q8_B.ElevationTransferFcn - heli_q8_B.Joystick_gain_y;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }
}
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3455000703U);
  heli_q8_M->Sizes.checksums[1] = (8164398U);
  heli_q8_M->Sizes.checksums[2] = (2497822660U);
  heli_q8_M->Sizes.checksums[3] = (1044319458U);
  ...
  heli_q8_M->Sizes.numBlocks = (88);   /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (30);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (625);/* Sum of parameter "widths" */
  return heli_q8_M;
}
