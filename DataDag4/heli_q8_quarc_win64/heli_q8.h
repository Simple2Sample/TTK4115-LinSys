...
typedef struct {
  ...
  real_T Sum1;                         /* '<S8>/Sum1' */
  real_T Sum2;                         /* '<S8>/Sum2' */
  real_T x_h1[6];                      /* '<Root>/xHatt  ' */
  real_T P_h[36];                      /* '<Root>/xHatt  ' */
  real_T x_1[6];                       /* '<Root>/Prediction  ' */
  real_T P_[36];                       /* '<Root>/Prediction  ' */
...
typedef struct {
  ...
  real_T UnitDelay1_DSTATE[36];        /* '<Root>/Unit Delay1' */
  ...
  struct {
    void *LoggedData[2];
  } Pitchrate1_PWORK;                  /* '<Root>/Pitchrate  1' */
  ...
  struct {
    void *LoggedData[2];
  } lambdaRate_PWORK;                  /* '<Root>/lambdaRate ' */
...
struct P_heli_q8_T_ {
  ...
  real_T PitchCounttorad_Gain;         /* Expression: -2*pi /4096
                                        ...
                                        */
  real_T UnitDelay1_InitialCondition[36];/* Expression: zeros(6,6)
 ...
 * '<S5>'   : 'heli_q8/IMU'
 * '<S6>'   : 'heli_q8/Joystick'
 * '<S7>'   : 'heli_q8/Prediction  '
 * '<S8>'   : 'heli_q8/Sick Controller Boi'
 * '<S9>'   : 'heli_q8/xHatt  '
 */
